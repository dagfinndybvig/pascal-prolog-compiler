...
> [!WARNING]
> This project implements only a **fragment of Pascal**. It supports integer arithmetic, typed booleans/chars, static arrays, records, named type aliases, typed pointers, and a focused feature subset that is just enough to do interesting work with algorithmic programs.
>
